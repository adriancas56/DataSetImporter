...
<template>
    <div  class="flex justify-between items-center bg-white border-b border-gray-400 top-0 sticky">
        <h1 class="text-xl px-5 ">{{route.meta.title || 'Data Set Importer'}}</h1>
        <h1 class="flex items-center text-gray-900 text-xl font-bold px-3 py-5 border-l border-gray-300">
