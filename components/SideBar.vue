...
<template>
    <div class="flex flex-col justify-between bg-gray-900 text-blue-100 left-0 top-0 h-screen sticky sidebar ">
        <nav class="py-24">
            <NuxtLink to="/" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white flex justify-center tooltip" activeClass="bg-green-500">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z" />
                </svg>
                <span class="tooltiptext">Home</span>
            </NuxtLink>
            <NuxtLink to="/categories" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white tooltip" activeClass="bg-green-500">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <NuxtLink to="/importer" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white tooltip" activeClass="bg-green-500">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <span class="tooltiptext">Importer</span>
            </NuxtLink>
            <NuxtLink to="/diagnostics" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white tooltip" activeClass="bg-green-500">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <div class="">
            <NuxtLink to="/user" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white tooltip" activeClass="bg-green-500">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <NuxtLink to="/user/logout" class="block py-3 px-2.5 hover:bg-gray-700 hover:text-white tooltip" @click="logout">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
